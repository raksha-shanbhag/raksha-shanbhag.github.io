export const workExpTermPoints = {
    "Full Stack Developer" : [
            { "one" : "Contributed to the startup’s Project Management tools for Microsoft add-ins, by solving over 50 tickets and stories under tight deadlines, while collaborating features with product, design, and engineering teams"},
    ...
    "Software Engineering Intern" : [
        { "one" : "Designed dynamic React components and Mobile pages complying with Figma designs of UI/UX team that were used by 15 projects across the company using Typescript."},
    ...
    "Software Developer" : [
        { "one" : "Collaborated on a multiplatform testing tool that assists testers run test routines on Ford’s vehicle ECUs"},
    ...
    "Software Infrastructure Developer" : [
        { "one" : "Fixed 25+ defects on Infotainment Software Architecture running on latest generation FORD vehicles using Ubuntu16.04 and QNX virtual environments"},
    ...
    "Application Developer" : [
        { "one" : "Designed a VB 6.0 module with the team, for teachers to record academic progress of Special needs students"},
